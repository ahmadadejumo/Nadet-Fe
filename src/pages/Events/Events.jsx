  ...
  return (
    <div className="font-Lato">
      ...
      <div className="bg-[#FFF8E8]">
        <h1 className="font-extrabold text-[28px] md:text-3xl lg:text-4xl text-center pt-[129px] px-5 md:px-28">
      ...
      <div className="pt-[80px]">
        ...
        <div className="md:flex md:justify-center lg:px-[140px]">
          <div className="flex justify-center pt-[50px] px-5 md:pt-1">
